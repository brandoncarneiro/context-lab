...
This is a fictionalized before/after example showing the kind of memory state Context Lab is designed to clean up.
...
- assume current business context that is no longer true
